...
CREATE TABLE `municipios` (
  ...
  `id_estado` mediumint(8) unsigned NOT NULL,
...
INSERT INTO `municipios` VALUES (1,1,'Álvaro Obregón','AO'),(2,1,'Benito Juárez','BJ'),(3,1,'Coyoacán','COY'),(4,1,'Miguel Hidalgo','MH'),(5,1,'Cuauhtémoc','CUA');
