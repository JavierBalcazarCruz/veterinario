...
--
-- Table structure for table `enfermedades_comunes`
--
...
--
-- Dumping data for table `enfermedades_comunes`
--

LOCK TABLES `enfermedades_comunes` WRITE;
/*!40000 ALTER TABLE `enfermedades_comunes` DISABLE KEYS */;
/*!40000 ALTER TABLE `enfermedades_comunes` ENABLE KEYS */;
UNLOCK TABLES;
