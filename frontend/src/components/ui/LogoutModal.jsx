// src/components/ui/LogoutModal.jsx - Modal para cambio de contraseña con efecto Liquid Glass
    ...
    <AnimatePresence mode="wait">
      <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 overflow-hidden">
        ...
        <motion.div
          ...
          style={{
            background: 'radial-gradient(circle at 50% 50%, rgba(16, 185, 129, 0.15) 0%, rgba(0, 0, 0, 0.6) 100%)'
          }}
        />
        ...
        <motion.div
          ...
          style={{
            background: 'radial-gradient(circle at 30% 40%, rgba(16, 185, 129, 0.2) 0%, transparent 60%), radial-gradient(circle at 70% 60%, rgba(34, 197, 94, 0.2) 0%, transparent 60%)',
            filter: 'blur(40px)'
          }}
        />
              ...
              <div className="flex flex-col items-center text-center space-y-6">
                ...
                <div className="relative">
                  ...
                  <motion.div
                    ...
                    style={{
                      ...
                      boxShadow: '0 8px 32px 0 rgba(16, 185, 129, 0.3), inset 0 2px 8px 0 rgba(255, 255, 255, 0.1)'
                    }}
                  >
                  ...
                  <motion.div
                    ...
                    className="absolute -bottom-2 -right-2 p-2 bg-green-500 rounded-full border-4 border-gray-900"
                  >
                ...
                >
                  ...
                  <p className="text-white/90 text-sm mb-2">
                    Por seguridad, cerraremos tu sesión para que inicies con tu nueva contraseña
                  </p>
                  <div className="flex items-center justify-center space-x-3">
                    <motion.div
                      ...
                      className="w-3 h-3 rounded-full bg-gradient-to-br from-green-400 to-emerald-500 shadow-lg"
                    />
                    <span className="text-white/90 text-sm font-medium">
                      Cerrando sesión en <span className="text-2xl font-bold text-white mx-2">{countdown}</span> segundo{countdown !== 1 ? 's' : ''}
                    </span>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <span className="relative">Cerrar Sesión Ahora</span>
                </motion.button>
